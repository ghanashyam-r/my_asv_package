...
def getParameter():
    ...
    collect_btn_num = rospy.get_param("/ASV_CATAM_URDF_ASSEMBLY/collect_button_num")
    collect_btn_sym = rospy.get_param("/ASV_CATAM_URDF_ASSEMBLY/collect_button_sym")
    send_btn_num = rospy.get_param("/ASV_CATAM_URDF_ASSEMBLY/send_button_num")
    send_btn_sym = rospy.get_param("/ASV_CATAM_URDF_ASSEMBLY/send_button_sym")
    calibrate_btn_num = rospy.get_param("/ASV_CATAM_URDF_ASSEMBLY/calibrate_button_num")
    calibrate_btn_sym = rospy.get_param("/ASV_CATAM_URDF_ASSEMBLY/calibrate_button_sym")
    abort_btn_num = rospy.get_param("/ASV_CATAM_URDF_ASSEMBLY/abort_button_num")
    abort_btn_sym = rospy.get_param("/ASV_CATAM_URDF_ASSEMBLY/abort_button_sym")
    continue_btn_num = rospy.get_param("/ASV_CATAM_URDF_ASSEMBLY/continue_button_num")
    continue_btn_sym = rospy.get_param("/ASV_CATAM_URDF_ASSEMBLY/continue_button_sym")
    
    sim_enabled = rospy.get_param("/ASV_CATAM_URDF_ASSEMBLY/sim_enabled")
...
def getPaths():
    ...
    if sim_enabled == True:
        location_collect = rospack.get_path('ASV_CATAM_URDF_ASSEMBLY') + "/launch/collect_goals_sim.launch"
        location_send = rospack.get_path('ASV_CATAM_URDF_ASSEMBLY') + "/launch/send_goals_continuous_sim.launch"
        location_calibrate = rospack.get_path('ASV_CATAM_URDF_ASSEMBLY') + "/launch/include/heading_calibration_sim.launch"
        location_safety_node = rospack.get_path('ASV_CATAM_URDF_ASSEMBLY') + "/launch/include/safety_node.launch"

    elif sim_enabled == False:
        location_collect = rospack.get_path('ASV_CATAM_URDF_ASSEMBLY') + "/launch/include/collect_goals.launch"
        location_send = rospack.get_path('ASV_CATAM_URDF_ASSEMBLY') + "/launch/include/send_goals_continuous.launch"
        location_calibrate = rospack.get_path('ASV_CATAM_URDF_ASSEMBLY') + "/launch/include/heading_calibration.launch"
        location_safety_node = rospack.get_path('ASV_CATAM_URDF_ASSEMBLY') + "/launch/include/safety_node.launch"
...
def launch_subscribers():
    ...
    rospy.Subscriber("/ASV_CATAM_URDF_ASSEMBLY/calibrate_status",Bool, calibrate_status_CB )
    rospy.Subscriber("/ASV_CATAM_URDF_ASSEMBLY/collection_status",Bool, collection_status_CB )
    rospy.Subscriber("/ASV_CATAM_URDF_ASSEMBLY/waypoint_following_status",Bool, waypoint_following_status_CB )
