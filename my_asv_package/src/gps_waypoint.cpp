...
{
    path_abs = ros::package::getPath("ASV_CATAM_URDF_ASSEMBLY") + path_local;
...
int main(int argc, char** argv)
{
    ...
    ros::Publisher pubWaypointNodeEnded = n.advertise<std_msgs::Bool>("/ASV_CATAM_URDF_ASSEMBLY/waypoint_following_status", 100);
